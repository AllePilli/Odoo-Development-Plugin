...
/**
 * This function can be computationally expensive, it is advised to only use this function when the [addonPaths] have not been set in [GeneralSettingsConfigurable]
